...
int main()
{
   ...
   ShapeArray[2] = &cylinder;
   // Showing The Dynamic Binding in Action 
   for ( int i = 0; i < 3; i++ )
   {
	   cout << " This Shape is " << ShapeArray[i]->getName() << endl;
	   cout << " The Area of it is " << ShapeArray[i]->getArea() << endl;
	   cout << " The Volume of it is " << ShapeArray[i]->getVolume() << endl;
	   ShapeArray[i]->print();
	   cout << endl;
   }
   ...
   //for ( int i = 0; i < 3; i++ ) 
    //  virtualViaPointer( ShapeArray[ i ] );
